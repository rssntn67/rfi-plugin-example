...
import it.xeniaprogetti.rfi.plugin.example.TopologyForwarder;
import it.xeniaprogetti.rfi.plugin.example.model.Topology;

@Command(scope = "opennms-rfi-plugin-example", name = "push-topology", description = "Push the topology")
@Service
